	...
	if (isLoading) {
		return (
			<div className="DivLInicial">  
				<center>
					<div className="div2"><img className="initialImg" src="https://raw.githubusercontent.com/FaniGE/app_ecommerce/main/img/cargando.gif"/></div>
				</center>
			</div>);
					...
					<Col key={`/product?id=${item._id}`}>
						<Card style={{width:'100%', height:'100%',}}>
							{item.image != null && item.image.trim().length > 5 ? (
								...
								<Card.Img variant="top" src="https://raw.githubusercontent.com/FaniGE/app_ecommerce/main/img/not-found.jpg" alt="Not found" width={250} height={230}/> 
							)}
							<Card.Body>
